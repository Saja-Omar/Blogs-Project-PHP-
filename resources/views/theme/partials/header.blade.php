          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-center">
              ...
              <li class="nav-item @yield('category.active') submenu dropdown">
                ...
                @if (count($data)>0)
                    @foreach ($data as $val)
                    <li class="nav-item"><a class="nav-link" href="{{route('theme.category',['id'=>$val->id])}}">{{$val->name}}</a></li>
                    @endforeach
                @endif
               </ul>
            ...
            <ul class="nav navbar-nav navbar-right navbar-social">
              ...
              <a href="{{route('register')}}" class="btn btn-sm btn-warning">Register / Login</a>
                ...
                <li class="nav-item submenu dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li class="nav-item"><a class="nav-link" href="{{route('blogs.my-blog')}}">My Blog</a></li>
                    <li class="nav-item">
